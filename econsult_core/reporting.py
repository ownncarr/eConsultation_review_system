...
def top_keywords(texts: List[str], top_n: int = 25) -> List[Tuple[str, int]]:
    ...
    stop = set([
    # --- Basic English (merged from NLTK + SpaCy + common lists) ---
    ...
    # --- Domain-specific (policy/legal common fillers) ---
    "section","clause","article","draft","proposed","proposal","regulation","rule",
    "subsection","chapter","paragraph","stakeholder","ministry","government",
    "notification","please","request","submit","comment","comments","consultation",
    "authority","department","board","council","official","agency","law","legal",
    "shall","may","will","must","hereby","thereof","whereas","therein","thereby",
    "herein","hereby","hereafter","herewith","aforesaid",
    # --- Extra noise ---
    "etc","eg","ie","yes","no","ok","okay","na","none","null","true","false",
])
    freqs = {}
    for t in tokens:
        if t in stop:
